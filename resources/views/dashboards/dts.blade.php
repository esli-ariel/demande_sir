        ...
        <div class="relative z-10 py-12">
            <div class="mx-auto space-y-8 max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <x-stat-card color="blue" label="Total" :value="$stats['total'] ?? 0" icon="📄" />
                    <x-stat-card color="yellow" label="En attente" :value="$stats['en_attente'] ?? 0" icon="⏳" />
                    <x-stat-card color="green" label="Validées" :value="$stats['traitees'] ?? 0" icon="✅" />
                    <x-stat-card color="red" label="Rejetées" :value="$stats['rejetees'] ?? 0" icon="❌" />
