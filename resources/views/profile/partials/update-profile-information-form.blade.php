<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Mettre a jour vos informations de comptes.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="prenom" name="prenom" type="text" class="block w-full mt-1" :value="old('prenom', $user->prenom)" required autofocus autocomplete="prenom" />
